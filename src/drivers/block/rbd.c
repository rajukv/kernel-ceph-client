...
#ifdef UBUNTU_1404_COMPILE

BUS_ATTR(add, S_IWUSR, NULL, rbd_add);
BUS_ATTR(remove, S_IWUSR, NULL, rbd_remove);
BUS_ATTR(add_single_major, S_IWUSR, NULL, rbd_add_single_major);
...
static struct attribute *rbd_bus_single_major_attrs[] = {
	&bus_attr_add.attr,
	&bus_attr_remove.attr,
...
ATTRIBUTE_GROUPS(rbd_bus_single_major);

#else /* ! UBUNTU_1404_COMPILE */
...
#ifdef UBUNTU_1404_COMPILE
	rbd_bus_type.bus_groups = rbd_bus_groups;
#else /* ! UBUNTU_1404_COMPILE */
...
#ifdef UBUNTU_1404_COMPILE
		rbd_bus_type.bus_groups = rbd_bus_single_major_groups;
#else /* ! UBUNTU_1404_COMPILE */
